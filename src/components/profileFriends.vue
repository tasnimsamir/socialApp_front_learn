<template>
  ...
  >
    <v-list three-line>
      ...
      <div  v-for="friend in profileFriends"  :key="friend.id">
        <v-divider></v-divider>
        <v-list-item >
          <v-list-item-avatar>
...
import { mapGetters, mapActions } from "vuex";
  ...
  created: function () {
    this.getFrndsAccounts(Object.values(this.profiledetails.friends))
    this.$store.dispatch("GetProfile",this.profileid);
  },

      computed: {
    ...mapGetters({profiledetails:"StateProfile",profileFriends:"StateFriends",profileid:"StateProfileId"}),
  },
  methods:{
